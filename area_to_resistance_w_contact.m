function serpentine_res = area_to_resistance_w_contact(num_beams,Rs,Rl,res_c)
    %num_beams,Rs,Rl,res_c
    contact_res = [fliplr(res_c(2:num_beams)) res_c(1) res_c(2:num_beams)];
